...
nn_architecture=[
    ...
    {"input_dim": 4, "output_dim": 6, "activation": "relu", "type": "dense"},
    {"input_dim": 6, "output_dim": 8, "activation": "relu", "type": "dense"},
    {"input_dim": 8, "output_dim": 10, "activation": "relu", "type": "dense"},
    {"input_dim": 10, "diameter": 2, "stride": 2, "type": "maxpool"},
    {"input_dim": 5, "output_dim": 1, "activation": "sigmoid", "type": "dense"}
]
